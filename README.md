...
저는 “재사용성”과 “확장성”을 고려하여 직관적인 아키텍처를 설계하기 위해 노력하는 백엔드 개발자입니다.</br>
웹개발에서 좋은 아키텍처는 현실세계를 직관적으로 반영할 수 있는 것이라고 생각합니다. 코드를 직접 구현한 개발자가 아니더라도 해당 코드를 바로 이해하고 활용할 수 있는 설계는 효율적인 협업환경의 기반이 되기 때문입니다.</br>
나아가 직관적인 아키텍처는 리팩토링이나 확장시, 클린코드의 OCP 원칙을 준수할 수 있는 개발환경을 마련해줍니다.
![image](https://github.com/hgene0929/hgene0929/assets/90823532/98c35d65-4320-48e0-88f5-d18750ce8fe5)
 </div></br>
